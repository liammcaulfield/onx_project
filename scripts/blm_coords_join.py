#!/usr/bin/env python
"""
Add Latitude / Longitude to the BLM Download-Results CSV
by matching Lead Office → ADMU_NAME centroids in the
blm_natl_admu_field_poly_webpub layer.

Usage:
  python scripts/blm_coords_join.py \
      -z BLM_National_Administrative_Unit_B.gdb.zip \
      -i blm_active_projects.csv \
      -o blm_projects_with_coords.csv
"""
